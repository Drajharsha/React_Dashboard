...
class UserProfileNew extends React.Component {
    constructor(props) {
        super(props)
        ...
        return (
            <>
                ...
                <div className="user-profile-frame" onClick={() => {}}>
                    <div id="user-profile-container-new" className="user-profile-container">
                        <div className="topnav-session-container-new">
                            <div className="logout-button-new" onClick={this.handleSession}>{(this.props.isAuthenticated ? "SIGN OUT" : "LOGIN")}</div>
                        </div>
                        {this.props.user ? 
